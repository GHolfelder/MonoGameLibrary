...
public class GamePadInfo
{
    ...
    /// <summary>
    /// Gets the state of gamepad input during the previous update cycle.
    /// </summary>
    public GamePadState PreviousState { get; private set; }

    /// <summary>
    /// Gets the state of gamepad input during the current input cycle.
    /// </summary>
    ...
    /// <summary>
    /// The remaining time for the vibration to continue.
    /// </summary>
