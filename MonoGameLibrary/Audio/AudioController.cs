...
/// <summary>
/// The AudioController class will manage audio playback including sound effects and music.
/// </summary>
public class AudioController : IDisposable
{
    ...
    // Finalizer (Destructor) called when object is collected by the garbage collector.
