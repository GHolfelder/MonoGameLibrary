...
/// The class will store which tile goes where in our game world and provide methods
/// to draw the entire map.
/// </summary>
public class Tilemap
{
    ...
    public static Tilemap FromXml(ContentManager content, string filename)
    {
