...
### Current Version
- **[Version 1.0.25](releases/ReleaseNotes-1.0.25.md)** *(Latest)* - Performance Optimizations & API Improvements
  - **Performance Enhancements**: Optimized collision detection and rendering systems for better frame rates
  - **API Consistency**: Standardized method signatures and improved naming conventions
  - **Bug Fixes**: Resolved edge cases in room transitions and tilemap rendering
  - **Documentation Updates**: Enhanced code examples and improved inline documentation

### Previous Releases
- **[Version 1.0.24](releases/ReleaseNotes-1.0.24.md)** - Enhanced Character System, Debug Messages & Room Management
  - **Character Velocity Exposure**: `CharacterSprite.Velocity` property now publicly accessible for movement tracking and game logic
  - **Enhanced Debug System**: New `DebugSystem.AddDebugMessage()` with automatic deduplication and overlay integration
  - **Professional Room Management**: `RoomManagerBase` and `RoomManager` classes for seamless room transitions with spatial optimization
  - **QuadTree Integration**: Efficient exit detection for large maps with many transition points
- **[Version 1.0.23](releases/ReleaseNotes-1.0.23.md)** - Enhanced Developer Mode, FPS System & Multiple Maps
